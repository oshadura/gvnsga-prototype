...
void AlgorithmNSGA::NextStep() {
  ...
  populationcvs.open("GeantV.csv", std::fstream::app);
  // fParentPop->CVSOutput(fParentPop->CreateCVS("Population.csv"),
  // *fParentPop);
  fParentPop->CSVOutput(populationcvs, *fParentPop);
}
