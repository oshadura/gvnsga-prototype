...
ClassImp(HistogramManager)
    ...
    HistogramManager::CheckValue(ROOT::Internal::TTreeReaderValueBase *value) {
      if (value->GetSetupStatus() < 0) {
        std::cerr << "Error " << value->GetSetupStatus() << "setting up reader
    for "
                  << value->GetBranchName() << '\n';
        return false;
      }
    ...
    "
          ...
          case TTreeReader::kEntryDictionaryError:
            std::cerr
                << "Error: TTreeReader cannot find the dictionary for some
    data\n";
            break;
          }
          return false;
    ...
    // Creating monitoring canvas
        ...
        hPriority->Draw("SAME");
        //////////////////////////
        hSteps = new TH1F("hSteps", "Number steps for learning", 10000, 0,
    10000);
