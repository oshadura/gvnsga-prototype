...
class ParallelEvaluatePopServer : private ParallelEvaluatorBase,
                                  public EvaluatePopulationBase {

public:
  ParallelEvaluatePopServer(boost::mpi::environment &_mpi_env,
                            boost::mpi::communicator &_world,
                            ProblemDefinitions &_problem_defs)
...
public:
  ParallelEvaluatePopClient(boost::mpi::environment &_mpi_env,
                            boost::mpi::communicator &_world,
                            ProblemDefinitions &_problem_defs,
                            EvaluatorBase &_eval)
